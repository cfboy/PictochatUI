    ...
    function ($http, $log, $scope, $rootScope, $location, $routeParams) {
        ...
        this.usersReactions = function () {
            ...
            thisCtrl.userReactedList.push({
                "id": 1, "name": "Roberto", "lastName": "Torres", "reactionType": "Like"
            });
            thisCtrl.userReactedList.push({
                "id": 2, "name": "Cristian", "lastName": "De Jesus", "reactionType": "Dislike"
            });
            thisCtrl.userReactedList.push({
                "id": 3, "name": "Jose", "lastName": "Nieves", "reactionType": "DisLike"
            });
            thisCtrl.userReactedList.push({
                "id": 4, "name": "Renier", "lastName": "Loquito", "reactionType": "Like"
            });
        };
